							...
							<div class="main-menu">
								...
								<div class="collapse navbar-collapse">		  
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="smooth-menu"><a href="kiaalap-master/monPanier.jsp">Mon Panier</a></li>
										<li class="smooth-menu"><a href="#blog">blog</a></li>
										<li class="smooth-menu"><a href="http://localhost:8006/agence_voyage_S5/contact.jsp">Contact	</a></li>
										<li>
...
<c:forEach items="${book}" var="e">
						  			<div class="col-md-6">
						  				<div class="filtr-item">
											<img src="data:image/jpg;base64,${e.getBaseImage()}" alt="portfolio image"/>

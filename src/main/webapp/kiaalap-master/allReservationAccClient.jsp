							...
							<div class="main-menu">
								...
								<div class="collapse navbar-collapse">		  
									<ul class="nav navbar-nav navbar-right">
										<li class="smooth-menu"><a href="http://localhost:8083/agence_voyage_S5/">home</a></li>
		...
		<section id="pack" class="packages">
			<div class="container">
				...
				<div class="packages-content">
					...
					<c:forEach items="${listeReVAccClient}" var="e">
						
						<div class="col-md-4 col-sm-6">
							<div class="single-package-item">
								<img src="data:image/jpg;base64,${e.getBaseImage()}" alt="package-place">
								<div class="single-package-item-txt">
									<h3><c:out value="${e.getDestination()}" /> <span class="pull-right"><c:out value="${e.getPrix()}" />MAD</span></h3>
									<div class="packages-para">
										<p>
											<span>
												<i class="fa fa-angle-right"></i> Date depart
											</span>
											<i class="fa fa-angle-right"></i> <c:out value="${e.getDate_depart()}" />
										</p>
										<p>
											<span>
												<i class="fa fa-angle-right"></i>  Date fin
											</span>
											<i class="fa fa-angle-right"></i> <c:out value="${e.getDate_fin()}" />
										 </p>
									</div><!--/.packages-para-->

                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="nom_voyage" type="text" class="form-control" placeholder="Nom du voyage">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="nom_guide" type="text" class="form-control" placeholder="Nom du guide">
                                                                </div>
                                                                 <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="date_depart" id="finish" type="text" class="form-control" placeholder="Date de depart">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="duree" id="postcode" type="text" class="form-control" placeholder="La duree">
                                                                </div>

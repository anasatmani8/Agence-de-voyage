								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">All Courses</span></li>
										</ul>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
						<div class="courses-inner res-mg-b-30">
							<div class="courses-title">
								<a href="#"><img src="data:image/jpg;base64,${book.baseImage}" width="140" height="100"/></a>
							...
							<div class="product-buttons">
								<button type="button" class="button-default cart-btn"><h3><c:out value="${book.prix}" /></h3></button>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">

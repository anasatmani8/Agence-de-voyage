			...
			<div class="left-custom-menu-adp-wrap comment-scrollbar">
				<nav class="sidebar-nav left-sidebar-menu-pro">
					<ul class="metismenu" id="menu1">
						<li><a class="has-arrow" href="index.html"> <span
								class="educate-icon educate-home icon-wrap"></span> <span
								class="mini-click-non">Education</span>
						</a>
						...
						<li><a class="has-arrow" href="all-students.html"
							...
							<ul class="submenu-angle" aria-expanded="false">
								...
								<li><a title="Edit Students" href="edit-student.html"><span
										class="mini-sub-pro">Edit Student</span></a></li>
						...
						<li class="active"><a class="has-arrow"
							href="all-courses.html" aria-expanded="false"><span
											...
											<ul class="nav navbar-nav mai-top-nav">
												...
												<li class="nav-item dropdown res-dis-nn"><a href="#"
													...
													<div role="menu" class="dropdown-menu animated zoomIn">
														<a href="#" class="dropdown-item">Documentation</a> <a
															href="#" class="dropdown-item">Expert Backend</a> <a
															href="#" class="dropdown-item">Expert FrontEnd</a> <a
															href="#" class="dropdown-item">Contact Support</a>
													</div></li>
							...
							<div class="mobile-menu">
								<nav id="dropdown">
									<ul class="mobile-menu-nav">
										...
										<li><a data-toggle="collapse" data-target="#demomi"
											href="#">Mailbox <span
												class="admin-project-icon edu-icon edu-down-arrow"></span></a>
							...
							<div class="breadcome-list">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div style ="margin-right:-50px;" class="breadcome-heading">
											<form action="chercherParPrix" method="post" class="sr-input-func">
												<input name="prix_search" type="text" placeholder="Search by price" title="Type in a category"
													class="search-int form-control"> <a><i
													class="fa fa-search"></i></a>
											</form>
										</div>
									</div>
									<div style ="margin-left:-300px;" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
										<div style ="margin-right:-50px;" class="breadcome-heading">
											<form action="chercherParDestination" method="post"  class="sr-input-func">
											<input  type="text" id="mySearch" onkeyup="myFunction()" placeholder="Search by destination" title="Type in a category"
													class="search-int form-control"><a ><i
													class="fa fa-search"></i></a>
											</form>
										</div>
								...
								<div  id="td" class="courses-alaltic">
									<span class="cr-ic-r"><span class="course-icon"><i
										...
										class="cr-ic-r"><span class="course-icon"><i
											class="fa fa-dollar"></i></span> <c:out value="${e.getPrix() }" /></span>
								</div>
								<div id="td" class="course-des">
									<span><i class="fa fa-clock"></i></span> <b style="font-size: 24px;">Destination</b>
									<h3 style="font-size: 20px ;color: orange;">
										<c:out value="${e.getDestination()}" />
									</h3>
								</div>
								<div id="td" class="course-des">
									<span><i class="fa fa-clock"></i></span> <b  style="font-size: 24px;">Duree:</b>
									<h3 style="font-size: 20px ; color: orange;">

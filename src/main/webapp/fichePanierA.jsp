...
if (session.getAttribute("clt") == null) {
	System.out.println("test Client fichPanier.jsp");
    response.sendRedirect("loginCA.jsp");
  ...
  <main id="main">
    ...
    <section id="gallery" class="gallery">
      ...
      <c:forEach items="${voyage}" var="e">
        ...
        <div class="row gallery-container">
          ...
          <div class="col-lg-4 col-md-6 gallery-item filter-home">
            <div class="gallery-wrap">
             ...
             <img src="data:image/jpg;base64,${e.getBaseImage()}" width="700"
			               height="400"/><input
        ...
        <div> <p><strong>date depart :</strong><c:out value="${e.getDate_depart()}"></c:out></p>
              <p><strong>date fin :</strong><c:out value="${e.getDate_fin()}"></c:out></p>
              <p><strong>prix :</strong><c:out value="${e.getPrix()}"></c:out>Dh</p>
                <p><strong>destination :</strong><c:out value="${e.getDestination()}"></c:out></p>
                <input class="about-view packages-btn" type="button" onclick="window.location.href = 'reserverVoyageAcc?idClient=<c:out value="${idClient}"/>&idVoyage=<c:out value="${idVoyage}"/>&idDateVoyage=<c:out value="${idDateVoyage}"/>';" style="background-color: #299be4;" value="Reserver"/>
        </div>

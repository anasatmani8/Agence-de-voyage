...
<body>
	...
	<header id="header" class="fixed-top">
		<div
			...
			<h1 class="logo">
				<a href="index.html">Mon Panier</a>
			</h1>
				...
				<c:forEach items="${voyage}" var="e">
					...
					<div style="box-shadow: 6px 6px 6px black;">
						...
						<div>
							...
							<input class="about-view packages-btn" type="button" onclick="window.location.href = 'reserverVoyage?idClient=<c:out value="${idClient}"/>&idVoyage=<c:out value="${idVoyage}"/>&idDateVoyage=<c:out value="${idDateVoyage}"/>';" style="background-color: #299be4;" value="Reserver"/>
						</div>
					</div>

	...
	<main id="main">
		...
		<section id="gallery" class="gallery">
			<div class="container">
				...
				<br>
				<h3 style="margin-left: 500px;">Voici vos reservations</h3><br>  <p style="
    color: red; font-size:30px;
    margin-left: 15px; margin-bottom:-0.9rem;
" > ${nbrR}</p>  <p><i class='fas fa-shopping-cart' style='font-size:36px'></i></p>
				...
				<c:forEach items="${listeReV}" var="e">
					...
					<div style="box-shadow: 6px 6px 6px black;">
						...
						<div>
							...
							<form action="client_facture" method="post">
							<input type="text" name="nbrPersonne" placeholder="Nombre de personne"><br>
							<input  type="submit" value="Generer facture" >
							</form>
							
							
							<strong>Inserer nombre de personne :</strong>
							
									<input class="about-view packages-btn" type="button" onclick="window.location.href = 'libererReservation';" style="background-color: #ba0202;" value="Liberer"/>
				<!-- 		<input class="about-view packages-btn" type="button" onclick="window.location.href = 'client_facture?idClient=<c:out value="${idClient}"/>&idDateVoyageAcc=<c:out value="${idDateVoyage}"/>&idVoyageAcc=<c:out value="${idVoyage}"/>';" style="background-color: #299be4;" value="telecharger facture"/>  -->
						</div>
					</div>
